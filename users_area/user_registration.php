    ...
    <div class="row d-flex align-items-center justify-content-center">
        <div class="col-lg-12 col-xl-6">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4">
                    <label for="user_upi" class="form-label">Enter your UPI ID</label>
                    <input type="text" id="user_upi" class="form-control" placeholder="Enter your UPI ID" autocomplete="off" required="required" name="user_upi">
                </div>
...
if(isset($_POST['user_register'])) {
    ...
    $user_scanner=$_FILES['user_scanner']['name'];
    $user_scanner_tmp=$_FILES['user_scanner']['tmp_name'];
    ...
    $insert_query="insert into `user_table` (username,user_email,user_password,user_image,user_ip,user_address,user_mobile,upi_id,upi_scanner) values ('$user_username','$user_email','$hash_password','$user_image','$user_ip','$user_address','$user_contact','$user_upi','$user_scanner')";
