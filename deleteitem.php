...
if(!isset($_SESSION['username'])){
    ...
    echo"
    <a href='./users_area/profile.php?username=$username'> <img src='./users_area/user_images/$result_image' width='40' height='40' class='rounded-circle'></a>
    ";
}
                ...
                <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="./index.php"style="color:white; font-size:24px;"><b>Home</b></a>
                </li>
...
flex-direction:column;
color: aliceblue;">
    <div class="actualtext " style=" color: aliceblue; text-align:center;">
<p>
   <b> INVENTORY</b>
</p>
<p>
